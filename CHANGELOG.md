...
- Resuming an audiobook larger than the render cache no longer re-renders its first chapters; the cache is trimmed after a job and never drops chapters a job is using
